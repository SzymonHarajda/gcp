const flashcards = [
  {
    ...
    answer:
      "D.\n1. Establish a VPN or Interconnect tunnel to a VPC in Google Cloud. [cite: 6]\n2. [cite_start]Use Cloud Router to advertise the custom route 199.36.153.4/30. [cite: 6]\n3. [cite_start]Configure your on-premises DNS server to resolve *.googleapis.com as a CNAME pointing to restricted.googleapis.com, and announce the network via the VPN tunnel. [cite: 7]",
  },
  {
    question:
    ...
    answer:
      'C.\n- Have each team member generate an SSH key pair and add the public key to their Google account. [cite: 13][cite_start]\n- Grant the "compute.osAdminLogin" role to the Google group corresponding to the operations team. [cite: 13]',
  },
  {
    question:
    ...
    answer:
      "D. [cite_start]In the Google Cloud Platform Console, create a new billing account and set up a payment method. [cite: 20]",
  },
  {
    question:
    ...
    answer:
      "B. [cite_start]Run it on Compute Engine, and choose a custom instance type with 6 vCPUs and 32 GB of memory. [cite: 25]",
  },
  {
    question:
    ...
    answer:
      "D. [cite_start]Use “kubectl config use-context” and “kubectl config view” to review the output. [cite: 31]",
  },
  {
    question:
    ...
    answer:
      "A. [cite_start]Link TutorVerse's projects to Learnly's billing account. [cite: 35]",
  },
  {
    question:
    ...
    answer:
      "D.\n- Upload images to a Cloud Storage bucket and monitor the bucket for new uploads. [cite: 46][cite_start]\n- Trigger a Cloud Function to convert the images and store them back in a Cloud Storage bucket. [cite: 46]",
  },
  {
    question:
    ...
    answer:
      "A. [cite_start]Use “gcloud iam roles copy” and specify the production project as the destination project. [cite: 51]",
  },
  {
    question:
    ...
    answer: "B. [cite_start]10.0.0.0/8 [cite: 57]",
  },
  {
    question:
  ...
  },
  {
    ...
    answer: "A. [cite_start]Deploy the container on Cloud Run. [cite: 67]",
  },
  {
    question:
    ...
    answer:
      "C.\n1. [cite_start]In Cloud Logging, create a filter to display only Compute Engine logs. [cite: 75]\n2. [cite_start]Click Create Export. [cite: 75]\n3. [cite_start]Select BigQuery as the Sink Service and the app-logs dataset as the Sink Destination. [cite: 75]",
  },
  {
    question:
    ...
    answer:
      "B. [cite_start]Create an export to the sink that saves logs from Cloud Audit to a Coldline Storage bucket. [cite: 82]",
  },
  {
    question:
    ...
    answer: "D. [cite_start]Coldline Storage [cite: 88]",
  },
  {
    question:
    ...
    answer:
      "C.\n1. [cite_start]Create a service account. [cite: 94]\n2. [cite_start]Give the Cloud Run Invoker role to that service account for your SnapWave application. [cite: 95]\n3. [cite_start]Create a Cloud Pub/Sub subscription that uses that service account and uses your SnapWave application as the push endpoint. [cite: 95]",
  },
  {
    question:
    ...
    answer:
      "A. [cite_start]Reserve the IP 10.194.3.41 as a static internal IP address using gcloud and assign it to the licensing server. [cite: 101]",
  },
  {
    question:
    ...
    answer:
      "C.\n- Export the billing data to BigQuery. [cite: 107][cite_start]\n- Create a Cloud Function that uses BigQuery to sum the egress network costs of the exported billing data for the Apache web server for the current month and send an email if it is over 100 dollars. [cite: 107][cite_start]\n- Schedule the Cloud Function using Cloud Scheduler to run hourly. [cite: 108]",
  },
  {
    question:
    ...
    answer:
      "C.\n- Create a managed instance group. [cite: 116][cite_start]\n- Set the Autohealing health check to healthy (HTTP) [cite: 116]",
  },
  {
    question:
    ...
    answer:
      "C.\n- Create a GKE cluster with autoscaling enabled on the node pool. [cite: 123][cite_start]\n- Set a minimum and maximum for the size of the node pool. [cite: 123]",
  },
  {
    question:
    ...
    answer: "C. [cite_start]Enable the compute googleapis.com API. [cite: 129]",
  },
  {
    question:
    ...
    answer:
      "D. [cite_start]Automatic Scaling with min_idle_instances set to 4. [cite: 135]",
  },
  {
    question:
  ...
  },
  {
    ...
    answer:
      "A.\n- Select Cloud SQL (MySQL). [cite: 146][cite_start]\n- Verify that the enable binary logging option is selected. [cite: 147]",
  },
  {
    question:
    ...
    answer:
      "B.\n1. [cite_start]Instruct your developers to visit the Cloud Marketplace. [cite: 155]\n2. [cite_start]Ask them to launch a pre-configured Cassandra image for their development needs. [cite: 155]",
  },
  {
    question:
    ...
    answer:
      "C. [cite_start]Create another project with the ID zephyr-design-hub for the design team and deploy the resources there. [cite: 162]",
  },
  {
    question:
    ...
    answer:
      "B.\n1. [cite_start]Set up a Cloud Monitoring Workspace and link it to your Google Cloud Platform (GCP) project. [cite: 169]\n2. [cite_start]Create a Cloud Monitoring Alerting Policy with a 90% CPU threshold. [cite: 169]\n3. [cite_start]Add your email address to the notification channel. [cite: 169]",
  },
  {
    question:
    ...
    answer:
      "A. [cite_start]Add the operations team group to the roles/monitoring.viewer role [cite: 177]",
  },
  {
    question:
    ...
    answer:
      "D.\n- Create a Cloud Monitoring alerting policy to send an alert to a webhook when Cloud Spanner CPU is above or below your threshold. [cite: 184][cite_start]\n- Set up a Cloud Function that listens for HTTP requests and resizes the Spanner resources automatically. [cite: 185]",
  },
  {
    question:
    ...
    answer:
      "A. [cite_start]Invite the employee to transfer their existing Google account. [cite: 189]",
  },
  {
    question:
  ...
  },
  {
    ...
    answer:
      "B. [cite_start]Use gcloud to create a key file for the service account that has appropriate permissions. [cite: 200]",
  },
  {
    question:
    ...
    answer:
      "B.\n- Migrate the customer dashboard to App Engine and the backend API to Cloud Run. [cite: 207][cite_start]\n- Use Cloud Tasks to schedule the data processing task on Cloud Run. [cite: 207]",
  },
  {
    question:
    ...
    answer: "A. [cite_start]Deploy a private autopilot cluster. [cite: 214]",
  },
  {
    question:
    ...
    answer:
      "C.\n- Create an alert in Cloud Monitoring to notify you when high-priority CPU utilization reaches 65%. [cite: 222][cite_start]\n- If this threshold is exceeded, add more nodes to your Cloud Spanner instance. [cite: 222]",
  },
  {
    question:
    ...
    answer:
      "A.\n- For each Google Cloud product used in the solution, review the pricing details on the product’s pricing page. [cite: 228][cite_start]\n- Use the pricing calculator to total the monthly costs for each Google Cloud product. [cite: 228]",
  },
  {
    question:
      "NovaPayments, a fictional online invoicing platform, is planning to migrate its invoice records from its local data center to Cloud Storage. The invoices have specific requirements as mentioned below. NovaPayments wants to adopt Google's best practices to reduce operational and development costs. [cite_start]What should they do?\n- The invoices must be retained for a minimum of five years. [cite: 236][cite_start]\n- Up to five versions of the same invoice need to be saved, in case any corrections or updates are made. [cite: 237][cite_start]\n- Invoices that are older than one year should be transferred to a lower-cost storage tier. [cite: 237]",
    answer:
      "D.\n- Enable object versioning on the Cloud Storage bucket [cite: 242][cite_start]\n- Configure lifecycle conditions to adjust the storage classes [cite: 242][cite_start]\n- Specify the number of versions, and delete outdated invoices. [cite: 242]",
  },
  {
    question:
    ...
    answer:
      "A. [cite_start]Modify the existing subnet range to 10.0.2.0/24. [cite: 246]",
  },
  {
    question:
    ...
    answer:
      "A. [cite_start]Use the command “gcloud config set container/cluster chat-prod”. [cite: 254]",
  },
  {
    question:
    ...
    answer:
      "C. [cite_start]Migrate to use a Local SSD on the instance. [cite: 260]",
  },
  {
    question:
    ...
    answer:
      "B.\n- Configure the Horizontal Pod Autoscaler for availability [cite: 265][cite_start]\n- Configure the Vertical Pod Autoscaler recommendations for suggestions. [cite: 266]",
  },
  {
    question:
    ...
    answer:
      "C.\n- Create a new service account and assign this service account to the new instance. [cite: 275][cite_start]\n- Grant the service account permissions on Cloud Storage. [cite: 275]",
  },
  {
    question:
    ...
    answer:
      "D.\n- Use the Google Cloud Pricing Calculator to determine the cost of every Google Cloud resource you expect to use. [cite: 283][cite_start]\n- Use similar size instances for the web server, and use your current on-premises machines as a comparison for Cloud SQL. [cite: 284]",
  },
  {
    question:
    ...
    answer:
      "B.\n- Configure regional storage for the region closest to the users. [cite: 289][cite_start]\n- Configure a Standard storage class. [cite: 289]",
  },
  {
    question:
    ...
    answer:
      "A.\n- Deploy the platform on App Engine. [cite_start]For each update, create a new version of the same service. [cite: 296][cite_start]\n- Configure traffic splitting to send a small percentage of traffic to the new version. [cite: 296]",
  },
  {
    question:
    ...
    answer:
      "C.\n- Navigate to the Audit Logs page in the Google Cloud console, and enable Data Read, Data Write, and Admin Read logs for the Bigtable instance. [cite: 306][cite_start]\n- Create a Pub/Sub topic as a Cloud Logging sink destination, and add your SIEM as a subscriber to the topic. [cite: 306]",
  },
  {
    question:
  ...
  {
    question:
      "A software development company, SwiftData Solutions, has created two separate environments on Google Cloud Kubernetes (GKE) for its application as mentioned below. You have used the kubectl get nodes command but are only able to view the nodes from the prod-environment. [cite_start]What commands should you execute to verify the node status for the dev-environment?\n- prod-environment, set up as a standard cluster. [cite: 317][cite_start]\n- dev-environment, which is an auto-pilot cluster. [cite: 318]",
    answer:
      "A.\n1. gcloud container clusters get-credentials dev-environment [cite: 319][cite_start]\n2. kubectl get nodes [cite: 319]",
  },
  {
    question:
      "Your team at ByteDome, a fast-growing app development company specializing in personalized game experiences, has noticed that developers frequently use multiple service account keys in their projects. To improve security and standardize practices, you need to implement a temporary solution while working on a long-term fix. Your requirements are mentioned below. You aim to implement a Google-recommended approach that is cost-effective and adheres to these requirements. [cite_start]What should you do?\n- Creating all service accounts requiring keys in a centralized project named game-sa-hub. [cite: 326][cite_start]\n- Ensuring that any service account keys issued are valid for only one day. [cite: 326]",
    answer:
      "C.\n- Enforce an organization policy constraint that limits the lifetime of service account keys to 24 hours. [cite: 329][cite_start]\n- Additionally, enforce an organization policy constraint that denies service account key creation, with an exception for game-sa-hub. [cite: 329]",
  },
  {
    question:
    ...
    answer:
      "D.\n- Create multiple service accounts, one for each pipeline, with the appropriate minimal IAM permissions. [cite: 338][cite_start]\n- Use a secret management service to store the key files of these service accounts. [cite: 339][cite_start]\n- Allow the CI/CD pipeline to request the necessary secrets during execution. [cite: 339]",
  },
  {
    question:
    ...
    answer: "C. [cite_start]SSL Proxy Load Balancer [cite: 344]",
  },
  {
    question:
    ...
    answer:
      "D. [cite_start]Use GCP Marketplace to launch a pre-configured Jenkins solution. [cite: 350]",
  },
  {
    question:
  ...
  },
  {
    ...
    answer:
      "D.\n- Set a Windows username and password in the GCP Console. [cite: 377][cite_start]\n- Confirm that a firewall rule for port 3389 is in place. [cite: 377][cite_start]\n- Click the RDP button in the GCP Console to log in using those credentials. [cite: 377]",
  },
  {
    question:
    ...
    answer:
      "A. [cite_start]In the project where the container images are stored, assign the Artifact Registry Reader IAM role to the service account used by the Kubernetes nodes. [cite: 381]",
  },
  {
    question:
  ...
  },
  {
    ...
    answer: "A. [cite_start]Deployment Manager [cite: 392]",
  },
  {
    question:
    ...
    answer:
      "D. [cite_start]Deploy the new version of TaskMaster in App Engine, then go to App Engine settings in GCP Console and split the traffic between the current version and the new version. [cite: 399]",
  },
  {
    question:
    ...
    answer:
      "B.\n- Use Cloud Storage Object Lifecycle Management with Age conditions, setting the actions to SetStorageClass and Delete. [cite: 404][cite_start]\n- Configure the SetStorageClass action to 90 days and the Delete action to 365 days. [cite: 405]",
  },
  {
    question:
    ...
    answer:
      "C.\n- Create a docker image from the Dockerfile and upload it to the Container Registry. [cite: 411]\n- Create a Deployment YAML file to point to that image. [cite_start]Use kubectl to create the deployment with that file. [cite: 411]",
  },
  {
    question:
    ...
    answer:
      "A. [cite_start]Run “gcloud projects list” to get the project ID, and then run “gcloud services list --project <project ID>”. [cite: 417]",
  },
  {
    question:
    ...
    answer:
      "D. [cite_start]Export your bill to a BigQuery dataset, and then write time window-based SQL queries for analysis. [cite: 423]",
  },
  {
    question:
    ...
    answer:
      "A. [cite_start]Create a Kubernetes Service of type NodePort for your application, and a Kubernetes Ingress to expose this Service via a Cloud Load Balancer. [cite: 427]",
  },
  {
    question:
    ...
    answer:
      "C.\n- Select the built-in IAM project Viewer role. [cite: 437][cite_start]\n- Add the auditor's account to this role. [cite: 437]",
  },
  {
    question:
    ...
    answer:
      "D.\n- Create a custom Compute Engine image from a snapshot. [cite: 446][cite_start]\n- Create your instances from that image. [cite: 446]",
  },
  {
    question:
  ...
  },
  {
    ...
    answer:
      "B. [cite_start]Grant the VM Service Account the role Storage Object Creator on mealmetrics-central-bucket. [cite: 458]",
  },
  {
    question:
    ...
    answer:
      "B.\n- Verify that both projects are part of a GCP Organization. [cite: 465][cite_start]\n- Share the VPC from one project and allow the Compute Engine instances in the other project to use this shared VPC. [cite: 465]",
  },
  {
    question:
    ...
    answer:
      "A.\n- Fill in local SSD. [cite: 472][cite_start]\n- Fill in persistent disk storage and snapshot storage. [cite: 472]",
  },
  {
    question:
    ...
    answer:
      "C. [cite_start]Inspect the pending pod travelbooking-deployment-x2y3z4-lm89d and look for warning messages. [cite: 480]",
  },
  {
    question:
    ...
    answer:
      "A.\n- Set metadata to enable-oslogin=true for the instance. [cite: 485][cite_start]\n- Grant the dev1 team the compute.osLogin role. [cite: 485][cite_start]\n- Instruct them to use the Cloud Shell to SSH into the instance. [cite: 486]",
  },
  {
    question:
    ...
    answer:
      "A. [cite_start]Using the Cloud SDK, create a new project, enable the Compute Engine API in that project, and then create the instance specifying your new project. [cite: 494]",
  },
  {
    question:
    ...
    answer:
      "C.\n- Migrate the workload to a Compute Engine VM. [cite: 501][cite_start]\n- Start and stop the instance as needed. [cite: 501]",
  },
  {
    question:
    ...
    answer:
      "D. [cite_start]Ingest the data into Cloud Bigtable and create a row key based on the event's timestamp. [cite: 508]",
  },
  {
    question:
    ...
    answer:
      "B.\n- Use the command line to run a dry run query to estimate the number of bytes read. [cite: 514][cite_start]\n- Then convert that bytes estimate to dollars using the Pricing Calculator. [cite: 514]",
  },
  {
    question:
    ...
    answer:
      "D. [cite_start]Upload the image to the Container Registry and create a Kubernetes Deployment referencing the image. [cite: 522]",
  },
  {
    question:
    ...
    answer:
      "B. [cite_start]Use folders to group resources that share common IAM policies. [cite: 526]",
  },
  {
    question:
  ...
  },
  {
    ...
    answer:
      "D. [cite_start]Enable the API, create a workspace under Apollo, and add Luna and Nova projects to it. [cite: 537]",
  },
  {
    question:
    ...
    answer:
      "B.\n- Create a node pool with compute-optimized machine type nodes for the image processing service. [cite: 541][cite_start]\n- Use the node pool with general-purpose machine type nodes for the other services. [cite: 542]",
  },
  {
    question:
    ...
    answer:
      "C.\n- Use a custom mode VPC network [cite: 551][cite_start]\n- Use Cloud Router border gateway protocol (BGP) routes [cite: 551][cite_start]\n- Use active/passive routing. [cite: 551]",
  },
  {
    question:
  ...
  },
  {
    ...
    answer:
      "B. [cite_start]Use the BigQuery interface to review the nightly job and look for any errors. [cite: 564]",
  },
  {
    question:
    ...
    answer:
      "B. [cite_start]Use Cloud Spanner to store user data associated with their course completion progress. [cite: 570]",
  },
  {
    question:
    ...
    answer:
      "D. [cite_start]Set the CLOUDSDK_PROXY_USERNAME and CLOUDSDK_PROXY_PASSWORD properties using environment variables in your system's command line tool. [cite: 576]",
  },
  {
    question:
    ...
    answer:
      "D.\n- Create a cluster with both a Spot VM node pool and a node pool using standard VMs. [cite: 583][cite_start]\n- Deploy the critical deployments on the node pool using standard VMs and the fault-tolerant deployments on the Spot VM node pool. [cite: 584]",
  },
  {
    question:
    ...
    answer:
      "A.\n- Deploy the application to Cloud Run. [cite: 588][cite_start]\n- Use gradual rollouts for traffic splitting. [cite: 589]",
  },
  {
    question:
    ...
    answer:
      "C.\n- Ensure that the OS Config agent is installed on the Compute Engine instance. [cite: 599][cite_start]\n- Provide the security team member roles/osconfig.vulnerabilityReportViewer permission. [cite: 599]",
  },
  {
    question:
    ...
    answer:
      "B. [cite_start]Gradually roll out the new revision and split customer traffic between the revisions to allow rollback in case a problem occurs. [cite: 605]",
  },
  {
    question:
  ...
  },
  {
    ...
    answer:
      "C.\n- Instruct the external contractor to generate an SSH key pair, and request the public key from the contractor. [cite: 616][cite_start]\n- Add the public key to the instance yourself, and have the contractor access the instance through SSH with their private key. [cite: 617]",
  },
  {
    question:
    ...
    answer:
      "B.\n- Use Cloud Logging filters to create log-based metrics for firewall and instance actions. [cite: 623][cite_start]\n- Monitor the changes and set up reasonable alerts. [cite: 623]",
  },
  {
    question:
  ...
  },
  {
    ...
    answer:
      "D. [cite_start]Grant roles/bigquery.dataViewer role to QuickServe-database and appropriate roles to QuickServe-frontend. [cite: 636]",
  },
  {
    question:
    ...
    answer:
      "A. [cite_start]Modify the existing subnet range to 10.18.20.0/24. [cite: 640]",
  },
  {
    question:
    ...
    answer:
      "A. [cite_start]Set the europe-west1-d zone as the default zone using the gcloud config subcommand. [cite: 647]",
  },
  {
    question:
    ...
    answer:
      "A. [cite_start]Deploy Jenkins through the Google Cloud Marketplace. [cite: 652]",
  },
  {
    question:
    ...
    answer:
      "A.\n1. [cite_start]Verify that you are assigned the Billing Administrator IAM role for SwiftMedia's Google Cloud Project related to the Marketing department. [cite: 660]\n2. [cite_start]Link the new project for AdWave to a Marketing Billing Account. [cite: 660]",
  },
  {
    question:
    ...
    answer:
      "A. [cite_start]Create a multi-region Cloud Spanner instance with an optimized schema. [cite: 669]",
  },
  {
    question:
    ...
    answer:
      'D. [cite_start]Use the "--preview" flag to execute the Deployment Manager template in the same project, then review the status of dependent resources. [cite: 675]',
  },
  {
    question:
    ...
    answer:
      "D.\n1. [cite_start]Cloud Dataflow [cite: 684]\n2. [cite_start]Cloud Bigtable [cite: 685]\n3. [cite_start]BigQuery [cite: 685]",
  },
  {
    question:
    ...
    answer:
      "A. [cite_start]Add the auditors group to the 'logging.viewer' and 'bigquery.dataViewer' predefined IAM roles. [cite: 690]",
  },
  {
    question:
    ...
    answer:
      "C. [cite_start]Create a service account and add it to the IAM role 'storage.objectCreator' for that bucket. [cite: 697]",
  },
  {
    question:
    ...
    answer:
      "A. [cite_start]Using the GCP Console, filter the Activity log to view the information. [cite: 702]",
  },
  {
    question:
    ...
    answer:
      "A. [cite_start]Create a signed URL with a four-hour expiration and share the URL with the company. [cite: 707]",
  },
  {
    question:
    ...
    answer:
      "A.\n- Filter the Activity log to view the Configuration category. [cite: 714][cite_start]\n- Filter the Resource type to Service Account. [cite: 714]",
  },
  {
    question:
    ...
    answer:
      "B. [cite_start]Deploy the monitoring pod in a DaemonSet object. [cite: 722]",
  },
  {
    question:
    ...
    answer:
      "A. [cite_start]Use gcloud to expand the IP range of the current subnet. [cite: 727]",
  },
  {
    question:
    ...
    answer:
      "B. [cite_start]Assign the necessary IAM roles to the users by using their WorkSuite email addresses. [cite: 733]",
  },
  {
    question:
    ...
    answer:
      "A.\n- Create two configurations using “gcloud config configurations create [NAME]”. [cite: 738][cite_start]\n- Run “gcloud config configurations activate [NAME]” to switch between accounts when running the commands to start the Compute Engine instances. [cite: 738]",
  },
  {
    question:
    ...
    answer:
      "A.\n- Create two configurations using gcloud config. [cite: 746][cite_start]\n- Write a script that sets configurations as active, individually. [cite: 746][cite_start]\n- For each configuration, use “gcloud compute instances list” to get a list of compute resources. [cite: 746]",
  },
  {
    question:
    ...
    answer:
      "C.\n- Create external tables in BigQuery that reference the Cloud Storage bucket. [cite: 754][cite_start]\n- Run SQL queries directly on these external tables. [cite: 754]",
  },
  {
    question:
    ...
    answer:
      "A. [cite_start]Use gcloud to create the new project, and then deploy your application to the new project. [cite: 759]",
  },
  {
    question:
    ...
    answer:
      "C.\n- Add a network tag of your choice to the instance. [cite: 765][cite_start]\n- Create a firewall rule to allow ingress on UDP port 636 for that network tag. [cite: 765]",
  },
  {
    question:
    ...
    answer:
      "A.\n- Verify that you are the project billing administrator. [cite: 771][cite_start]\n- Select the associated billing account and create a budget and alert for the appropriate project. [cite: 771]",
  },
  {
    question:
    ...
    answer:
      "A. [cite_start]Create the instance without a public IP address. [cite: 778]",
  },
  {
    question:
  ...
  },
  {
    ...
    answer:
      "D.\n- Add a new node pool with GPU support to the existing GKE cluster. [cite: 790][cite_start]\n- Then, request the Data Analytics team to use the cloud.google.com/gke-accelerator: nvidia-tesla-p100 nodeSelector in their pod specification. [cite: 791]",
  },
  {
    question:
    ...
    answer: "B. [cite_start]Storage Admin [cite: 795]",
  },
  {
    question:
    ...
    answer:
      "B.\n- Create a new Node Pool and specify machine type n2-highmem-16. [cite: 801][cite_start]\n- Deploy the new pods. [cite: 802]",
  },
  {
    question:
    ...
    answer:
      "D.\n- Create two separate BigQuery external tables on Cloud Storage and Cloud Bigtable. [cite: 809][cite_start]\n- Use the BigQuery console to join these tables through user fields, and apply appropriate filters. [cite: 809]",
  },
  {
    question:
    ...
    answer:
      "A. [cite_start]When creating the VM, use machine type n1-standard-96. [cite: 814]",
  },
  {
    question:
    ...
    answer:
      "A.\n- Create Compute Engine resources in us-central1-b. [cite: 820][cite_start]\n- Balance the load across both us-central1-a and us-central1-b. [cite: 821]",
  },
  {
    question:
    ...
    answer:
      "B. [cite_start]Add a bucket lifecycle rule that archives data with newer versions after 30 days to Nearline Storage. [cite: 828]",
  },
  {
    question:
    ...
    answer:
      "D. [cite_start]Use the command “gcloud projects get-iam-policy” to see the current role assignments. [cite: 834]",
  },
  {
    question:
    ...
    answer:
      "B.\n1. [cite_start]In the Cloud Console, go to the Compute Engine Disks page and select your instance's disk. [cite: 840]\n2. [cite_start]In the Snapshot Schedule section, select Create Schedule and configure the following parameters: [cite: 840][cite_start]\n- Schedule frequency: Daily [cite: 841][cite_start]\n- Start time: 1:00 AM – 2:00 AM [cite: 841][cite_start]\n- Autodelete snapshots after: 30 days [cite: 841]",
  },
  {
    question:
    ...
    answer:
      "A. [cite_start]Configure Billing Data Export to BigQuery and visualize the data in Data Studio. [cite: 848]",
  },
  {
    question:
    ...
    answer:
      "A.\n- Run a test using simulated maintenance events. [cite: 853][cite_start]\n- If the test is successful, use preemptible N1 Standard VMs when running future jobs. [cite: 854]",
  },
  {
    question:
    ...
    answer:
      "C. [cite_start]Enable Private Google Access on the subnet within the custom VPC. [cite: 861]",
  },
  {
    question:
    ...
    answer:
      "A.\n- Use the projects.move method to move the project to your organization. [cite: 866][cite_start]\n- Update the billing account of the project to TechFusion Inc.'s billing account. [cite: 867]",
  },
  {
    question:
    ...
    answer:
      "C.\n- Create one A record to point techfolio.com to the load balancer [cite: 876][cite_start]\n- Create two CNAME records to point WWW and HOME to techfolio.com respectively. [cite: 876]",
  },
  {
    question:
    ...
    answer:
      "D.\n- Configure Cloud Billing data export to BigQuery for the billing account. [cite: 883][cite_start]\n- Create a Looker Studio dashboard on top of the BigQuery export. [cite: 883]",
  },
  {
    question:
    ...
    answer:
      "B.\n- Search for the PMP solution in Google Cloud Marketplace. [cite: 889][cite_start]\n- Deploy the solution directly from Cloud Marketplace. [cite: 890]",
  },
  {
    question:
    ...
    answer:
      "A.\n- Create a Billing account and associate a payment method with it [cite: 896][cite_start]\n- Provide all project creators with permission to associate that billing account with their projects. [cite: 896]",
  },
  {
    question:
    ...
    answer:
      "D.\n- Ingest the data into Bigtable. [cite: 905][cite_start]\n- Create a row key based on the event timestamp. [cite: 905]",
  },
  {
    question:
    ...
    answer:
      "A.\n- Run “gcloud auth login”, enter your login credentials in the dialog window, and paste the received login token to the gcloud CLI. [cite: 910]\nE. [cite_start]Run “gcloud config set project $my_project” to set the default project for the gcloud CLI. [cite: 913]",
  },
  {
    question:
    ...
    answer:
      "A. [cite_start]Open the Google Cloud console, and check the Identity and Access Management (IAM) roles assigned to the service account at the project or inherited from the folder or organization levels. [cite: 918]",
  },
  {
    question:
    ...
    answer:
      "B. [cite_start]Use the command “gcloud auth activate-service-account” and point it to the private key. [cite: 1562]",
  },
  {
    question:
    ...
    answer:
      "C.\n- Send orders to Pub/Sub. [cite: 1570][cite_start]\n- Process them in VMs in a managed instance group. [cite: 1570]",
  },
  {
    question:
    ...
    answer:
      "B. [cite_start]Use Cloud VPN to create a bridge between the VPC and your network. [cite: 1575]",
  },
  {
    question:
    ...
    answer:
      "C.\n- Store the data in Cloud Bigtable [cite: 1582][cite_start]\n- Implement the business logic in the programming language of your choice. [cite: 1583]",
  },
  {
    question:
    ...
    answer:
      "D.\n- Deploy the encoding service to an instance group [cite: 1592][cite_start]\n- Set the autoscaling based on CPU utilization. [cite: 1592]",
  },
  {
    question:
  ...
  },
  {
    ...
    answer:
      "A. [cite_start]Deploy your Docker containers into Cloud Run. [cite: 1601]",
  },
  {
    question:
    ...
    answer:
      "D.\n- Create groups. [cite: 1610][cite_start]\n- Assign an IAM Predefined role to each group as required, including those who should have access to sensitive data. [cite: 1610][cite_start]\n- Assign users to groups. [cite: 1611]",
  },
  {
    question:
      "You are managing data for a popular food delivery app called QuickBite. The app has specific data retention guidelines as given below. You want to implement these guidelines automatically and in the simplest way possible. [cite_start]What should you do?\n- Archive order records older than one year. [cite: 1615][cite_start]\n- Delete order records older than five years. [cite: 1615][cite_start]\n- Store all other data in standard storage. [cite: 1615]",
    answer:
      "A. [cite_start]Set up Object Lifecycle management policies. [cite: 1616]",
  },
  {
    question:
    ...
    answer:
      "B. [cite_start]Upload the data to Cloud Storage using the gcloud storage command. [cite: 1623]",
  },
  {
    question:
  ...
  },
  {
    ...
    answer:
      "B. [cite_start]Use Cloud Function events, and call the compliance script from the Cloud Function triggers. [cite: 1635]",
  },
  {
    question:
    ...
    answer:
      "C.\n1. [cite_start]Create a dedicated Google group in Cloud Identity. [cite: 1642]\n2. [cite_start]Add each data analyst's user account to the group. [cite: 1642]\n3. [cite_start]Assign the BigQuery Job User role to the group. [cite: 1642]",
  },
  {
    question:
    ...
    answer:
      "C. [cite_start]Create a temporary account for the auditor in Cloud Identity, and give that account the Viewer role on the project. [cite: 1648]",
  },
  {
    question:
    ...
    answer:
      "A.\n1. [cite_start]Go to the Logs ingestion window in Stackdriver Logging, and disable the log source for the GKE container resource. [cite: 1654]",
  },
  {
    question:
    ...
    answer:
      "B. [cite_start]Deploy the new version in the same application and use the --splits option to give a weight of 98 to the current version and a weight of 2 to the new version. [cite: 1661]",
  },
  {
    question:
    ...
    answer:
      "B. [cite_start]Perform a rolling-action start-update with maxSurge set to 1 and maxUnavailable set to 0. [cite: 1668]",
  },
  {
    question:
    ...
    answer: "B. [cite_start]Cloud Spanner [cite: 1675]",
  },
  {
    question:
    ...
    answer:
      "C.\n- View Data Access audit logs in Cloud Logging. [cite: 1683][cite_start]\n- Search for the user's email as the principal. [cite: 1683]",
  },
  {
    question:
    ...
    answer:
      "C. [cite_start]Assign the finance team the Billing Account User role on the billing account and the Project Billing Manager role on the organization. [cite: 1688]",
  },
  {
    question:
    ...
    answer:
      "C.\n1. [cite_start]In GKE, create a Service of type LoadBalancer that uses the CloudCart application’s Pods as backend. [cite: 1696]\n2. [cite_start]Add an annotation to this service: cloud.google.com/load-balancer-type: Internal [cite: 1697]\n3. [cite_start]Peer the two VPCs together. [cite: 1697]\n4. [cite_start]Configure the Compute Engine instance to use the load balancer's address that has been created. [cite: 1697]",
  },
  {
    question:
    ...
    answer:
      "B. [cite_start]Create a snapshot schedule for the disk using the desired interval. [cite: 1703]",
  },
  {
    question:
    ...
    answer:
      "B.\n- Create a Stackdriver Logging Export with a Sink destination to a BigQuery dataset. [cite: 1709][cite_start]\n- Configure the table expiration to 60 days. [cite: 1710]",
  },
  {
    question:
    ...
    answer:
      "A.\n1. [cite_start]Verify that you are assigned the Project Owner IAM role for this project. [cite: 1716]\n2. [cite_start]Locate the project in the GCP console, click Shut Down, and then enter the project ID. [cite: 1716]",
  },
  {
    question:
    ...
    answer:
      "A.\n1. [cite_start]Create a subnetwork in the same VPC, in europe-west1. [cite: 1723]\n2. [cite_start]Create the new instance in the new subnetwork and use the first instance's private address as the endpoint. [cite: 1724]",
  },
  {
    question:
    ...
    answer:
      "B.\n- Assign the auditor the IAM role roles/logging.privateLogViewer. [cite: 1733][cite_start]\n- Direct the auditor to also review the logs for changes to Cloud IAM policy. [cite: 1733]",
  },
  {
    question:
    ...
    answer:
      "B. [cite_start]Create the following two firewall rules:\n#1: Ingress:\nTarget: All instances with tier#2 service account, [cite: 1743][cite_start]\nSource: All instances with tier#1 service account, [cite: 1744][cite_start]\nProtocols: TCP 8080 [cite: 1744][cite_start]\n#2: Ingress:\nTarget: All instances with tier#3 service account, [cite: 1745][cite_start]\nSource: All instances with tier#2 service account, [cite: 1745][cite_start]\nProtocols: TCP 8080 [cite: 1745]",
  },
  {
    question:
  ...
  },
  {
    ...
    answer:
      "A.\n1. [cite_start]Create a configuration for each project you need to manage. [cite: 1761]\n2. [cite_start]Activate the appropriate configuration when you work with each of your assigned Google Cloud projects. [cite: 1762]",
  },
  {
    question:
    ...
    answer:
      "B.\n- Save the automatic first-of-the-month backup for three years. [cite: 1770][cite_start]\n- Store the backup file in an Archive class Cloud Storage bucket. [cite: 1770]",
  },
  {
    question:
  ...
  },
  {
    ...
    answer: "C. [cite_start]Use Cloud Spanner for data storage. [cite: 1783]",
  },
  {
    question:
    ...
    answer:
      "D. [cite_start]Assign the IAM role of BigQuery User to a Google Group that includes all the members of the analytics team. [cite: 1790]",
  },
  {
    question:
  ...
  },
  {
    ...
    answer:
      "A.\n- Use permissions in the role that has the 'supported' support level for role permissions. [cite: 1800][cite_start]\n- Set the role stage to ALPHA while testing the role permissions. [cite: 1801]",
  },
  {
    question:
  ...
  },
  {
    ...
    answer:
      "B.\n- Create a node pool with compute-optimized machine type nodes for the image rendering service. [cite: 1819][cite_start]\n- Use the node pool with general-purpose machine type nodes for the other services. [cite: 1819]",
  },
  {
    question:
  ...
  },
  {
    ...
    answer:
      "D.\n- Lift and shift to a VM on Compute Engine. [cite: 1833][cite_start]\n- Use an instance schedule to start and stop the instance. [cite: 1834]",
  },
  {
    question:
    ...
    answer:
      "B.\n- Create a GKE Autopilot cluster. [cite: 1840][cite_start]\n- Enroll the cluster in the stable release channel. [cite: 1840]",
  },
  {
    question:
    ...
    answer:
      "A.\n1. [cite_start]Create a single VPC with a subnet for the DMZ and a subnet for the LAN. [cite: 1847]\n2. [cite_start]Set up firewall rules to allow relevant traffic between the DMZ and LAN subnets, and another firewall rule to allow public ingress traffic for the DMZ. [cite: 1847]",
  },
  {
    question:
  ...
  },
  {
    ...
    answer:
      "B.\n- Use the “gcloud services enable compute.googleapis.com” command to enable Compute Engine. [cite: 1860][cite_start]\n- Use the “gcloud services enable storage.googleapis.com” command to enable the Cloud Storage APIs. [cite: 1860]",
  },
  {
    question:
    ...
    answer:
      "D.\n- Upload Docker images to Artifact Registry [cite: 1868][cite_start]\n- Deploy the application on Cloud Run. [cite: 1869]",
  },
  {
    question:
    ...
    answer:
      "D.\n- Store the application data on a regional persistent disk. [cite: 1877][cite_start]\n- If an outage occurs, create an instance in another zone with this disk attached. [cite: 1877]",
  },
  {
    question:
  ...
  },
  {
    ...
    answer:
      "B.\n- Store the data in BigQuery. [cite: 1894][cite_start]\n- Run SQL queries in BigQuery. [cite: 1894]",
  },
  {
    question:
  ...
  },
  {
    ...
    answer:
      "A.\n- Use your existing CI/CD pipeline. [cite: 1924][cite_start]\n- Use the generated Docker images and deploy them to Cloud Run. [cite: 1925][cite_start]\n- Update the configurations and the required endpoints. [cite: 1925]",
  },
  {
    question:
  ...
  },
  {
    ...
    answer:
      "D.\n- Use the Cloud Foundation Toolkit to create one deployment template that will work for all environments [cite: 1951][cite_start]\n- Deploy with Terraform. [cite: 1951]",
  },
  {
    question:
    ...
    answer:
      "C.\n- Create an instance template. [cite: 1958][cite_start]\n- Set the disk type to be Hyperdisk Extreme. [cite: 1959][cite_start]\n- Launch the instance template as part of a stateful managed instance group. [cite: 1959]",
  },
  {
    question:
  ...
  },
  {
    ...
    answer:
      "B.\n- Create a new revision with the updated version of the app. [cite: 1480][cite_start]\n- Split traffic between this version and the current one. [cite: 1480]",
  },
  {
    question:
    ...
    answer:
      "A.\n- Turn on Data Access Logs for the buckets they want to audit. [cite: 1492][cite_start]\n- Build a query in the log viewer that filters on Cloud Storage. [cite: 1492]",
  },
  {
    question:
    ...
    answer:
      "B. [cite_start]Use the “gcloud compute instance-groups managed recreate-instances” command to recreate the VM. [cite: 1498]",
  },
  {
    question:
    ...
    answer:
      "C.\n- Enable identity federation between Cloud Identity and Google Workspace [cite: 1506][cite_start]\n- Enforce multi-factor authentication for domain-wide delegation. [cite: 1506]",
  },
  {
    question:
    ...
    answer:
      "D. [cite_start]Upload the image to the Artifact Registry and create a Kubernetes Deployment referencing the image. [cite: 1512]",
  },
  {
    question:
    ...
    answer:
      "D. [cite_start]Use the BigQuery interface to review the nightly job and look for any errors. [cite: 1517]",
  },
  {
    question:
      'Your company, "Techie Tools Inc.," is responsible for managing all Compute Engine instances in your sandbox environment. However, they should not be allowed to create or modify any other resources in the sandbox project. You want to adhere to Google\'s best practices for assigning permissions to the engineering team. What should you do?',
  ...
  },
  {
    ...
    answer:
      "B. [cite_start]Use kubectl to delete the topic resource. [cite: 1522]",
  },
  {
    question:
    ...
    answer:
      "A.\n- Create an instance template with valid syntax that will be used by the managed instance group. [cite: 1527][cite_start]\n- Delete any persistent disks that share the same name as instance names. [cite: 1527]",
  },
  {
    question:
    ...
    answer:
      "D. [cite_start]Set up Billing Data Export to BigQuery and use Looker Studio to visualize the data. [cite: 1537]",
  },
  {
    question:
    ...
    answer:
      "A.\n- Run a test using simulated maintenance events. [cite: 1542][cite_start]\n- If the test is successful, use Spot N2 Standard VMs when running future jobs. [cite: 1542]",
  },
  {
    question:
    ...
    answer:
      "C.\n- Write a script that uses the gsutil command line tool to synchronize the on-premises storage with Cloud Storage. [cite: 1551][cite_start]\n- Schedule this script to run as a cron job. [cite: 1552]",
  },
  {
    question:
    ...
    answer:
      "C. [cite_start]Create a group for the compliance team, and assign roles/bigquery.dataViewer to them. [cite: 1557]",
  },
  {
    question:
  ...
  },
  {
    ...
    answer:
      "A. [cite_start]Build a lifecycle policy to delete Cloud Storage objects after 50 days. [cite: 1247]\nB. [cite_start]Use signed URLs to allow vendors limited-time access for uploading their files. [cite: 1248]",
  },
  {
    question:
      "You are managing an online marketplace platform that uses Cloud Storage for storing user-uploaded product images and Firestore to store product listings and customer data. You are responsible for monitoring all changes in both the product images and listings. For each change, you need to invoke a verification action that ensures compliance of the new data in near real-time. You want to implement this with minimal configuration. What should you do?",
